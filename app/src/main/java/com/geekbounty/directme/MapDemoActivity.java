...
public class MapDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Checks if map api key is available
        ...
        // If the Map fragment is not null load the Map or display error message
        if (mapFragment != null) {
    ...
    /**
     * Handles Permission for android M 6.0
     * @param requestCode
     * @param permissions
     * @param grantResults
     */
    ...
    */
    ...
    /**
     * This function Triggers Location Update at Interval
     */
    @NeedsPermission({Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION})
